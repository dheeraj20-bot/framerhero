...
export const Header = () => {
  return (
    <div className="text-center py-5 border-b border-gray-600  bg-black-100  flex  justify-between items-center px-2 sm:px-20 w-full z-50 backdrop-blur-md text-white">
        <Link href="/">
            <Image
            src="/logo.png"
            width={125}
