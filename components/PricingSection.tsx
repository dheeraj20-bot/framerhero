...
const PricingSection = () => {
  return (
    <main className="max-w-7xl py-20 mx-auto px-4 sm:px-6 lg:px-8">
           <h2 className=" text-4xl sm:text-5xl font-bold mb-10  max-w-3xl  leading-tight  text-transparent bg-clip-text bg-gradient-to-br from-white to-gray-500 ">
    ...
    
     {
      pricingPlans.map((plan)=>(
          <div key={plan.title} className=" bg-zinc-950 even:-mt-3  hover:scale-105 duration-300 transition-all ease-in-out last:bg-gradient-to-r last:from-zinc-950 last:to-tealf-500 rounded-3xl h-[35rem]   border-gray-200 p-4">
                 <div>
