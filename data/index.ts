...
export const clientImages = [
    ...
    { name: "Fameoungeps", url: "/clients/Famelounge.webp" },
    { name: "Greenhouse", url: "/clients/green house.webp" },
    { name: "McDonald", url: "/clients/mc donalds.webp" },
    { name: "Tinder", url: "/clients/tinder.webp" },
    { name: "Alux", url: "/clients/alux.webp" },
    { name: "apreture", url: "/clients/apreture.webp" },
    { name: "buildapreneur", url: "/clients/buildapreneur.webp" },
    // { name: "Austin Rabin", url: "/clients/Austin Rabin.webp" },
    { name: "cars with sonduren", url: "/clients/cars with sonduren.webp" },
    { name: "5 min craft", url: "/clients/5 min craft.webp" },
    { name: "bestie", url: "/clients/bestie.webp" },
    { name: "jill", url: "/clients/jill.webp" },
    { name: "BJP", url: "/clients/bjp .webp" },
    { name: "crime curiousity", url: "/clients/crime curiousity .webp" },
    { name: "develop good habits", url: "/clients/develop good habits.webp" },
    { name: "futurology", url: "/clients/futurology.webp" },
    // { name: "jd williams", url: "/clients/jd williams.webp" },
    { name: "mega builds", url: "/clients/mega builds.webp" },
    { name: "Odyssey Informatics", url: "/clients/Odyssey Informatics.webp" },
    { name: "valeria (notalone )", url: "/clients/valeria (notalone ).webp" },
    { name: "what the fact", url: "/clients/what the fact.webp" },
  ];
